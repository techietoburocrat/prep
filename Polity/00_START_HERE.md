...
```mermaid
flowchart LR
  A["📗 <b>01_NCERT</b><br/><i>only if a concept<br/>feels too fast</i>"] -.-> B
  B["📘 <b>02_Laxmikanth</b><br/>read the chapter<br/><i>pass 1: understand</i>"] --> C["📘 re-read + make<br/><b>tables and traps</b> only<br/><i>pass 2: consolidate</i>"]
  C --> D["✏️ <b>03_PYQ_Prelims</b><br/>attempt the linked MCQs<br/><b>immediately</b>"]
  D --> E["📝 <b>04_PYQ_Mains</b><br/>write ONE answer from<br/>the chapter's expected list"]
  E --> F{"Got questions<br/>wrong?"}
  F -- Yes --> G["⭐ Mark that paragraph.<br/><b>Your wrong answers<br/>are your real syllabus</b>"]
  G --> C
  F -- No --> H["✅ Next chapter"]
  H --> B
```
