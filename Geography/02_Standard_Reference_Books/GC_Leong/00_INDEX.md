...
## 📌 Read this first — how these notes differ from every other folder

Every other notes folder in `Mission/` summarises a book. **This one does not.**

By the time you opened Leong, you had already finished **all 9 Geography NCERTs — 72 chapters, 90 files, 24,314 lines.** The [original plan](../../00_START_HERE.md) said Leong should be *interleaved* with Class 11 *Fundamentals*, chapter by chapter. That plan assumed you'd be reading them together. You aren't — Class 11 is done.

So Leong is not a second pass. **It is a delta.**

> ### 🔑 The one rule these notes obey
>
> **If your NCERT notes already say it, this folder does not repeat it — it links to it.**
>
> Every file opens with a **"What NCERT already gave you"** box pointing at the exact chapter, then covers *only the increment*. You should be able to read a Leong file in 20 minutes and know precisely what is new.

**Why that's the right call and not a shortcut:** a second full summary of the same content doesn't add knowledge, it adds *ambiguity* — two files on landforms that disagree slightly in emphasis, and a revision cycle that has to read both. One canonical note per concept, with a supplement where the supplement earns its place, is strictly better six months from now when you're revising at speed.

> ⚠️ **Chapter numbering varies between printings of Leong.** These notes are organised by **topic**, which is stable across editions, not by chapter number, which isn't. When you get your copy, check the topic against its contents page — don't assume "Leong Ch.7" means the same in your printing as in mine.

---

## 🎯 What Leong is actually for — the honest answer

Leong is on every UPSC booklist, and most candidates read it cover to cover. That is a waste of about fifteen hours. Here is what it genuinely gives you that nothing else does:
...
## 🗂️ The triage — every chapter accounted for

Three verdicts. **Nothing is skipped silently; every skip is listed with its reason and its replacement.**

### 🟢 FULL NOTE — Part B, the climate types (11 files)

**This is the reason Leong is on your list.** Written first, not last.

| # | Climate | Köppen | File |
|---|---|---|---|
| 1 | **Equatorial** — Hot, Wet | `Af` | [01_Equatorial_Hot_Wet.md](Part_B_Climate_Types/01_Equatorial_Hot_Wet.md) |
| 2 | **Tropical Monsoon & Tropical Marine** | `Am` | [02_Tropical_Monsoon_and_Marine.md](Part_B_Climate_Types/02_Tropical_Monsoon_and_Marine.md) |
| 3 | **Savanna** — Sudan type | `Aw` | [03_Savanna_Sudan_Type.md](Part_B_Climate_Types/03_Savanna_Sudan_Type.md) |
| 4 | **Hot Desert & Mid-latitude Desert** | `BWh`/`BWk` | [04_Hot_and_Mid_Latitude_Deserts.md](Part_B_Climate_Types/04_Hot_and_Mid_Latitude_Deserts.md) |
| 5 | **Mediterranean** — Warm Temp. Western Margin | `Cs` | [05_Mediterranean.md](Part_B_Climate_Types/05_Mediterranean.md) |
| 6 | **Steppe** — Temperate Continental | `BSk` | [06_Steppe_Temperate_Grassland.md](Part_B_Climate_Types/06_Steppe_Temperate_Grassland.md) |
| 7 | **China type** — Warm Temp. Eastern Margin | `Cfa`/`Cwa` | [07_China_Type_Warm_Temperate_Eastern_Margin.md](Part_B_Climate_Types/07_China_Type_Warm_Temperate_Eastern_Margin.md) |
| 8 | **British type** — Cool Temp. Western Margin | `Cfb` | [08_British_Type_Cool_Temperate_Western_Margin.md](Part_B_Climate_Types/08_British_Type_Cool_Temperate_Western_Margin.md) |
...
Each covers **only what NCERT left thin.** Sizes vary a lot on purpose — `03_Weathering` is short because NCERT Ch.6 is excellent; `10_Islands_and_Coral_Reefs` is long because NCERT barely mentions them.
...
**You told me never to silently drop content, and I haven't.** Within any chapter I note, the coverage is exhaustive. But *which chapters to note at all* is a strategy call — so here is every one I'm leaving out, with its reason and where the content actually lives. **Overrule any row and I'll write it.**

| Leong chapter / block | Why skipped | Where it's covered instead |
|---|---|---|
| **Human geography: world population & density** | Superseded, and Leong's figures are decades stale | [Cl.12 *Fundamentals* Ch.2–3](../../01_NCERT/Class_12_Fundamentals_of_Human_Geography/Notes/02_The_World_Population.md) |
| **Human geography: races of mankind** | ⚠️ **Obsolete and scientifically discredited.** Racial typology is not in the UPSC syllabus in any form | Nowhere — and correctly so |
| **Human geography: types of farming** | Superseded and better in NCERT | [Cl.12 *Fundamentals* Ch.5 Primary Activities](../../01_NCERT/Class_12_Fundamentals_of_Human_Geography/Notes/05_Primary_Activities.md) |
| **Human geography: forestry, fishing, mining** | Same | [Cl.12 *Fundamentals* Ch.5](../../01_NCERT/Class_12_Fundamentals_of_Human_Geography/Notes/05_Primary_Activities.md) · *fisheries* retained inside [Laurentian](Part_B_Climate_Types/10_Laurentian_Type_Cool_Temperate_Eastern_Margin.md) where it belongs causally |
| **Human geography: manufacturing industries** | Leong's industrial geography predates 1991 liberalisation *and* the entire IT sector | [Cl.12 *Fundamentals* Ch.6](../../01_NCERT/Class_12_Fundamentals_of_Human_Geography/Notes/06_Secondary_Activities.md) + [Cl.12 *India* Ch.8](../../01_NCERT/Class_12_India_People_and_Economy/Notes/08_Manufacturing_Industries.md) |
| **Human geography: transport & trade** | Same — stale statistics | [Cl.12 *Fundamentals* Ch.8–9](../../01_NCERT/Class_12_Fundamentals_of_Human_Geography/Notes/08_Transport_and_Communication.md) |
| **Regional geography of continents** | Not a GS requirement. This is optional-paper depth | Atlas work, [06_Maps/](../../06_Maps/) |
| **Map projections & surveying** | Not asked in GS Prelims or Mains | — |

> ⚠️ **One exception worth flagging inside the skip register.** Leong's *human* treatment of each **climate region** — the Masai, the Inuit, shifting-cultivation names, plantation crops — is **kept in full**, inside the Part B climate files. It's skipped only as a standalone Part Two. That content is examinable and it belongs attached to its climate, not floating in a separate section.

---

## 🔗 Cross-link map — Leong ↔ your NCERT notes

Use this when revising: it tells you which pair of files together cover a topic completely.

| Topic | Your NCERT note (canonical) | Leong supplement |
|---|---|---|
...
Identical to your NCERT notes, so nothing new to learn:
...
| 🗺️ | **Map pin** — trace this in the atlas during your 15-min daily habit; feeds [06_Maps/](../../06_Maps/) |
| 🎯 | **PYQ hook** — this has appeared, or its shape has |
| ⚠️ | A trap, a common error, or something stale in Leong you should not repeat in an answer |

### The Part B template — every climate file has these 9 sections

Same shape, every time, so revision becomes mechanical rather than exploratory:
...
6️⃣  SOIL
7️⃣  HUMAN ACTIVITY — peoples, crops, economy, problems
8️⃣  🌱 ENVIRONMENT — degradation, climate-change signal, current affairs
...
## ⏱️ Hours — revised down from the original plan

| Block | Original estimate | Revised | Why |
|---|---|---|---|
| Part B — 11 climate types | — | **9 hrs** | The real content. Don't compress this |
...
## 🪜 How to actually read this folder
...
| Item | Status |
|---|---|
| 📕 **The book itself** | `Textbook_PDF/` is empty. These notes are built on the standard OUP edition's structure — **verify topic-to-chapter mapping against your copy before relying on any chapter number** |
| 🌱 **Environment coverage in this folder** | Every climate file carries its environment overlay, but the **systematic** environment content (Acts, conventions, protected areas, biodiversity) is [Stage E2, Shankar IAS](../../00_START_HERE.md) — still unstarted, and the biggest remaining gap in the merged subject |

---

*Stage 3 of 11 · Companion to [Geography START HERE](../../00_START_HERE.md) · [Master Schedule](../../../00_MASTER_SCHEDULE.md)*
