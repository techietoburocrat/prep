...
> **The one-line point:** Agriculture is the **primary activity** that still employs the largest share of humanity, and every farming system on Earth sits somewhere on one axis: **growing food to eat yourself (subsistence)** versus **growing it to sell (commercial)**. Where a system sits on that axis explains almost everything else about it.

[← Ch.3](03_Mineral_and_Power_Resources.md) | [Index](00_Index.md) | [Next: Ch.5 →](05_Industries.md)
...
## 2️⃣ The Farm as a System

```
   INPUTS                PROCESSES              OUTPUTS
   ──────                ─────────              ───────
   Seeds                 Ploughing              Crops
   Fertilisers           Sowing                 Milk
   Machinery             Irrigating             Wool
   Labour                Weeding                Meat
   Land                  Harvesting             Eggs
   Water                 Threshing
```

**Seeing the farm as a system matters** because it shows where interventions act: better seeds and fertilisers are *input* changes; mechanisation is a *process* change. The Green Revolution was primarily an input change.
...
```
   FARMING
      │
      ├── SUBSISTENCE (grown mainly for the farmer's own consumption)
      │      │
      │      ├── INTENSIVE SUBSISTENCE
      │      │     Small plots, simple tools, LOTS of labour, high yield per hectare
      │      │     Monsoon Asia — RICE dominant. India, China, SE Asia
      │      │
      ...
      └── COMMERCIAL (grown mainly for SALE)
             ...
             │     Single crop, huge farms, highly mechanised
             │     Wheat, maize — PRAIRIES, PAMPAS, STEPPES
             │
             ├── MIXED FARMING
...
## 5️⃣ Two Farms Compared

NCERT sets an Indian farm beside an American one — again the **paired comparison** method.
...
## 6️⃣ 🌱 The Green Revolution — Gains and Costs

Introduced in the **1960s**: high-yielding variety (HYV) seeds, chemical fertilisers, pesticides, irrigation and mechanisation. Concentrated in **Punjab, Haryana and western UP**.
...
> 🌱 **The balanced verdict, which is what a Mains answer wants:** the Green Revolution **solved the problem it was designed to solve** — India does not have famines any more, and that is an enormous achievement not to be minimised. **But it externalised costs onto water, soil and regional equity**, and those bills are being presented now. **The current policy question is not whether it was right, but how to build a second transition that keeps the yields while repairing the ecology** — natural farming, millets, micro-irrigation, crop diversification.
...
| Term | Meaning |
|---|---|
| **Primary / secondary / tertiary** | Extractive / manufacturing / service activities |
| **Subsistence farming** | Grown mainly for the farmer's own consumption |
| **Intensive subsistence** | Small plot, heavy labour, high yield per hectare |
| **Shifting cultivation** | Slash-and-burn; **jhum** in NE India |
| **Nomadic herding** | Moving with livestock in search of pasture |
| **Commercial farming** | Grown mainly for sale |
| **Mixed farming** | Crops and livestock together |
| **Plantation** | Single cash crop on a large estate |
| **HYV seeds** | High-yielding varieties |
| 🌱 **Green Revolution** | 1960s productivity transformation via HYV seeds, fertiliser, irrigation |
| 🌱 **Shree Anna** | India's branding for millets |
...
10. 🌱 **Green Revolution ended famine — and cost groundwater, soil health, crop diversity and regional equity.** The task now is a second transition that keeps the yields and repairs the ecology.

---

## ✍️ Test Yourself

1. Cotton is best grown in which soil?
   → *Black soil (regur).*

2. Consider the following:
   1. Tea requires well-drained sloping land.
   2. Jute requires low rainfall.
   3. Millets are drought-resistant and can grow on poor soil.
   → *1 and 3 only. Jute needs **heavy** rainfall.*

3. Jhum cultivation is practised in:
   → *North-East India (a form of shifting cultivation).*

4. Which is a primary activity?
   (a) Steel making (b) **Mining** (c) Banking (d) Software → *(b).*

5. The world's largest producer of coffee is:
   → *Brazil.*

**Mains:** 🌱 *"The Green Revolution solved a food crisis and created an ecological one."* Examine, and suggest the shape of a second transition. **(150 words)**

**Self-check:** Classify farming in two branches and six types. Why does tea grow on slopes? Name three reasons to promote millets. What structurally limits Indian farm productivity?

---

[← Ch.3](03_Mineral_and_Power_Resources.md) | [Index](00_Index.md) | [Next: Ch.5 — Industries →](05_Industries.md)
