...
> **The one-line point:** Industries convert raw material into finished goods — and **where they locate is never accidental.** Every industrial city in the world sits where it does because of a specific balance of raw material, power, labour, transport and market. Learn the factors and you can explain any industrial map.

[← Ch.4](04_Agriculture.md) | [Index](00_Index.md) | [Next: Ch.6 →](06_Human_Resources.md)
...
```
   INDUSTRIES
      │
      ├── BY RAW MATERIAL
      │     ├── AGRO-BASED     — cotton textiles, sugar, tea, coffee, edible oil
      │     ├── MINERAL-BASED  — iron & steel, cement, aluminium, machinery
      │     ├── MARINE-BASED   — fish processing, fish oil
      │     └── FOREST-BASED   — paper, pulp, furniture, buildings
      │
      ...
      │
      └── BY OWNERSHIP
            ├── PRIVATE      — owned by individuals/companies (TISCO, Reliance)
...
## 2️⃣ The Industrial System

```
   INPUTS              PROCESSES              OUTPUTS
   ──────              ─────────              ───────
   Raw materials       Smelting               Finished goods
   Labour              Weaving                By-products
   Land, water         Assembling             (and 🌱 WASTE)
   Capital             Refining
   Power               Packaging
   Transport
```

> 🌱 **Note the output nobody lists: waste.** Every industrial process produces effluent, emissions and solid waste. **Treating waste as an unpriced output — an "externality" — is precisely the economic root of industrial pollution.** Saying that in a GS-III answer connects geography to economics properly.
...
>
> **That single distinction explains most industrial location patterns**, and it's a far better answer than reciting a list. *(This is Weber's least-cost theory in embryo — Class 12 develops it formally.)*

---

## 4️⃣ Major Industrial Regions

**World:** eastern North America, western and central Europe, eastern Europe, eastern Asia (China, Japan, Korea), and parts of India, Brazil and Australia.

**India:** Mumbai–Pune, Chhotanagpur, Ahmedabad–Vadodara, Chennai–Bengaluru, Gurugram–Delhi–Meerut, Kolkata–Hooghly.

> ⛏️ **The Chhotanagpur cluster explains itself** from Ch.3: iron ore, coal, manganese and limestone all within a small radius. **Jamshedpur, Rourkela, Bhilai, Durgapur, Bokaro** — India's steel plants sit there because the raw material does.

---

## 5️⃣ The Three Paired Case Studies

NCERT again uses **paired comparison** — same industry, two countries.

### ⚙️ Iron and Steel — Jamshedpur 🇮🇳 vs Pittsburgh 🇺🇸
...
> 🧵 **Osaka is the instructive one:** it became a great textile centre **with no domestic cotton at all**. Port access, cheap labour, humid climate and capital were enough. **This shows raw material is *one* factor, not a rule** — which is exactly the nuance a good Mains answer needs.
>
> **Why humidity matters:** cotton thread is less likely to snap in moist air, so humid regions historically had an advantage in spinning. Manchester itself was chosen for the same reason.

### 💻 Information Technology — Bengaluru 🇮🇳 vs Silicon Valley 🇺🇸
...
## 6️⃣ 🌱 Industrial Pollution and the Bhopal Disaster

### Types of industrial pollution

| Type | Source |
|---|---|
| **Air** | Smoke, particulates, SO₂, NOₓ from chimneys |
| **Water** | Untreated effluent into rivers — dyes, chemicals, heavy metals |
| **Land** | Solid waste, slag heaps, hazardous waste dumping |
...
>
> 🎯 **The analytical points that score:**
> 1. **Safety systems had been degraded** to cut costs before the leak — this was an economic decision, not an act of nature.
> 2. **Densely populated settlements had grown right against the plant** — a **land-use planning** failure as much as an industrial one.
> 3. **Liability and compensation remain contested decades later** — raising the question of corporate accountability across borders.
>
> **Bhopal is usable in GS-III (industrial safety, environment), GS-II (regulation, accountability) and Ethics (corporate responsibility, the value of a life).** Few examples work in three papers.
...
| Term | Meaning |
|---|---|
| **Industry** | Economic activity converting raw material into finished goods, or providing services |
...
| 🌱 **Externality** | A cost (like pollution) not paid by the producer |
| 🌱 **Methyl isocyanate (MIC)** | The gas released at Bhopal |
| 🌱 **EPA 1986** | Environment (Protection) Act, enacted after Bhopal |
...
1. Which factor most explains the location of the iron and steel industry?
   → *Proximity to raw materials (iron ore, coal) — it is a weight-losing industry.*

2. Consider the following:
   1. Osaka's cotton textile industry relies on locally grown cotton.
   2. Ahmedabad is called the Manchester of India.
   3. Bengaluru's IT industry is located primarily because of skilled labour.
   → *2 and 3 only. Osaka **imports** all its cotton.*

3. The gas released in the Bhopal disaster was:
   → *Methyl isocyanate (MIC).*

4. AMUL is an example of which ownership type?
   → *Cooperative sector.*

**Mains:** Discuss the factors determining industrial location, and explain how knowledge industries have altered the classical model. **(150 words)**

**Self-check:** Give eight location factors. Explain weight-losing vs weight-gaining with an example each. Why did Bhopal happen and what law followed?

---

[← Ch.4](04_Agriculture.md) | [Index](00_Index.md) | [Next: Ch.6 — Human Resources →](06_Human_Resources.md)
