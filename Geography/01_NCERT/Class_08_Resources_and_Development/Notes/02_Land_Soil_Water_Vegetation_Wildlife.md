...
> **The one-line point:** These five are the resources everything else depends on — and all five are **renewable in principle and being degraded in practice.** The chapter's real content is the **conservation methods**, because those are what turn "we should protect soil" into something you can actually write about.

[← Ch.1](01_Resources.md) | [Index](00_Index.md) | [Next: Ch.3 →](03_Mineral_and_Power_Resources.md)
...
**Only ~30% of the Earth's surface is land**, and not all of it is habitable — deserts, high mountains and ice sheets are largely unusable.

### Land use

> **Land use** = how land is put to work — agriculture, forestry, mining, building, roads, industry.

**Factors determining it:** topography, soil, climate, minerals, water availability; and on the human side, **population density and technology**.
...
| Cause | Mechanism |
|---|---|
| **Deforestation** | Removes root binding; soil washes away |
| **Overgrazing** | Livestock strip vegetation cover |
| **Over-irrigation** | Waterlogging and **salinisation** |
| **Mining** | Leaves pits, spoil heaps, contaminated land |
| **Industrial effluents** | Chemical contamination |

**Conservation of land:** afforestation, controlled grazing, shelter belts, checks on overgrazing, stabilising sand dunes with thorny bushes, proper management of wasteland, control of mining, and proper disposal of industrial waste.
...
| Factor | Effect |
|---|---|
| **1. Parent rock** | Determines colour, texture, mineral content, chemistry. *(Basalt → black soil, Cl.7 Ch.2)* |
| **2. Climate** | Temperature and rainfall control the rate of weathering and humus formation |
| **3. Relief** | Altitude and slope — steep slopes lose soil; flat land accumulates it |
| **4. Flora, fauna and micro-organisms** | Determine the rate of humus formation; earthworms, bacteria, fungi |
| **5. Time** | Determines the thickness of the soil profile |

> 🧠 **Mnemonic:** **P**arent rock · **C**limate · **R**elief · **O**rganisms · **T**ime → **"PCROT"**. Or note that the first three are *physical* and the last two are *process* factors.

### The soil profile

```
   ┌──────────────────────────────────────────┐
   │  🌿 TOPSOIL (Horizon A)                  │  humus + minerals
   │     dark, fertile, where roots live      │  ← what erosion takes
   ├──────────────────────────────────────────┤
   │  🟤 SUBSOIL (Horizon B)                  │  less humus, more minerals
   │     transitional                          │     washed down from above
   ├──────────────────────────────────────────┤
   │  🪨 WEATHERED PARENT ROCK (Horizon C)    │  broken rock fragments
   ├──────────────────────────────────────────┤
   │  ▓▓ BEDROCK                              │  unweathered parent rock
   └──────────────────────────────────────────┘
```

**Erosion always takes Horizon A first** — the thin, dark, fertile layer that took centuries to build and holds all the humus.

### 🌱 Soil erosion — causes

| Natural | Human |
|---|---|
| Running water (sheet, rill, gully erosion) | **Deforestation** |
| Wind | **Overgrazing** |
...
**The distribution problem** (repeating from Cl.6 Ch.5 and Cl.7 Ch.5 because it's foundational): **97% salt, 3% fresh, most of that frozen — under 1% readily usable.**
...
| **Over-extraction of groundwater** | Extraction exceeding recharge |
...
>
> 🎯 **The argument that scores:** these systems were **decentralised, locally maintained, and matched to local rainfall patterns.** Their decline in favour of centralised canal and borewell systems is a major reason for groundwater collapse. **"Reviving traditional water harvesting" is a substantive policy recommendation, not a nostalgic one.**

---

## 4️⃣ 🌱 Natural Vegetation and Wildlife

*(Detail in [Cl.7 Ch.6](../../Class_07_Our_Environment/Notes/06_Natural_Vegetation_and_Wildlife.md) — this is the conservation layer.)*

Vegetation and wildlife form the **biosphere**, and they are interdependent — plants supply oxygen and food, animals supply CO₂ and disperse seeds.

### Threats

Deforestation · habitat loss · poaching · forest fires · pollution · **invasive species** · climate change · natural calamities.
...
> 🌱 **Know the IUCN Red List categories in order** — they appear in Prelims and current affairs constantly:
> **Extinct → Extinct in the Wild → Critically Endangered → Endangered → Vulnerable → Near Threatened → Least Concern.**
> Indian examples: **Great Indian Bustard** (Critically Endangered), **Asiatic lion** (Endangered), **Tiger** (Endangered), **Snow leopard** (Vulnerable).
...
**Trap 3:** *"Industry is India's largest water user."* **Agriculture/irrigation** is, by a wide margin.
**Trap 4:** *"CITES protects habitats."* It regulates **international trade** in species; habitat protection is domestic law.
...
| Term | Meaning |
|---|---|
| **Land use** | The purpose land is put to |
| **Community land / CPR** | Land owned collectively for common use |
| **Land degradation** | Decline in land quality and productivity |
| **Soil** | Weathered rock + humus + water + air |
| **Humus** | Decomposed organic matter in soil |
| **Soil profile** | The vertical sequence of soil layers (horizons) |
...
11. 🌱 **IUCN Red List: Extinct → Extinct in the Wild → CE → E → V → NT → LC.** **CITES** regulates trade.

---

## ✍️ Test Yourself

1. Which of these is a soil-forming factor?
   1. Parent rock 2. Relief 3. Time 4. Micro-organisms → *All four (plus climate).*

2. Ploughing along contour lines on a slope is done to:
   → *Slow run-off and prevent soil erosion.*

3. Consider the following:
   1. Horizon A is the topsoil containing humus.
   2. Gully erosion produces ravines.
   3. Industry is India's largest consumer of water.
   → *1 and 2 only. **Agriculture** is the largest water user.*

4. CITES is concerned primarily with:
   → *Regulating international trade in endangered species.*

**Mains:** 🌱 *"India's water crisis is a crisis of management, not of endowment."* Examine, with reference to traditional harvesting systems. **(150 words)**

**Self-check:** Name the five soil-forming factors. Explain why contour ploughing works. List seven soil conservation methods. Give the IUCN categories in order.

---

[← Ch.1](01_Resources.md) | [Index](00_Index.md) | [Next: Ch.3 — Mineral and Power Resources →](03_Mineral_and_Power_Resources.md)
