...
> **The one-line point:** India has **two completely different families of river** — Himalayan rivers that are **perennial, snow-fed and still cutting their valleys**, and Peninsular rivers that are **seasonal, rain-fed and long since settled into fixed courses.** Almost every question about Indian rivers is really testing whether you know which family a river belongs to.

[← Ch.2](02_Physical_Features_of_India.md) | [Index](00_Index.md) | [Next: Ch.4 →](04_Climate.md)
...
| Pattern | Shape | Where |
|---|---|---|
| **Dendritic** | Tree-like, branching | Where the river follows the land's natural slope |
| **Trellis** | Right-angled joins | Where hard and soft rock alternate in parallel bands |
| **Rectangular** | Sharp right angles | Strongly jointed rocky terrain |
| **Radial** | Outward from a central peak | Rivers off a dome or volcano — e.g. from the **Amarkantak** hills |
...
## 6️⃣ 🌱 River Pollution and Conservation

**Causes:** untreated **sewage** (the largest contributor), industrial effluent, agricultural run-off (fertiliser and pesticides), religious offerings and immersion, plastic waste, and reduced flow due to abstraction.
...
>
> **The insight: dilution is a river's own treatment mechanism, so water abstraction and water pollution are the same problem.** That framing is far stronger than listing schemes.

> 🌱 **River interlinking** — the National River Linking Project proposes transferring water from "surplus" to "deficit" basins. **Arguments for:** flood control, drought mitigation, irrigation, navigation. **Against:** enormous cost, displacement, ecological disruption, submergence of forests, the contested premise that any basin is truly "surplus", and interstate disputes. **Ken–Betwa is the first link approved.** A ready-made GS-III debate.
...
**Trap 6:** *"The Brahmaputra is called the Jamuna in Assam."* **Jamuna is in Bangladesh**; in Assam it's the Brahmaputra, in Arunachal the Dihang.
...
| **Seasonal river** | Flows mainly in the rainy season |
| **Estuary** | Funnel-shaped river mouth with no delta |
| **Rift valley** | Sunken block between two faults — Narmada, Tapi |
| **Meghna** | Name of the combined Ganga–Brahmaputra in Bangladesh |
...
1. The Bhagirathi and Alaknanda meet at:
   → *Devprayag, forming the Ganga.*

2. Consider the following:
   1. The Narmada flows through a rift valley.
   2. The Narmada forms a large delta.
   3. The Tapi flows westward.
   → *1 and 3 only. Narmada forms an **estuary**.*

3. Under the Indus Waters Treaty, which rivers were allocated to India?
   → *Ravi, Beas and Satluj (the eastern rivers).*

4. The Brahmaputra is known as ____ in Tibet and ____ in Bangladesh.
   → *Tsangpo; Jamuna.*

5. India's largest freshwater lake is:
   → *Wular (J&K).*

**Mains:** 🌱 *"River pollution in India cannot be solved without addressing environmental flow."* Examine. **(150 words)**

**Self-check:** Give six differences between Himalayan and Peninsular rivers. Trace the Brahmaputra's names. Why do Narmada and Tapi form estuaries? Name the Indus's five tributaries.

---

[← Ch.2](02_Physical_Features_of_India.md) | [Index](00_Index.md) | [Next: Ch.4 — Climate →](04_Climate.md)
